...
def train_cluster_net(args, train_codes, train_labels):
    ...
    dataset_obj = CustomDataset(args,train_codes, train_labels)
    ...
    trainer = pl.Trainer(logger=logger, max_epochs=args.max_epochs, gpus=args.gpus,
                         num_sanity_val_steps=0, checkpoint_callback=checkpoint_callback,
                         limit_train_batches=args.limit_train_batches, limit_val_batches=args.limit_val_batches, accelerator="ddp")
